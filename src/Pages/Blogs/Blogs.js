  ...
  return (
    <div className="grid sm:grid-cols-1 md:grid-cols-2 gap-20 mt-10 container mx-auto">
      ...
      <div className="question-two  border p-3">
        ...
        <p>
          First, to answer your question, you generally use middleware for this.
          One tried-and-true solution is to use Express as your web server and
          Mongoose as an ORM (Object Relational Mapper, a way to talk to the
          database from your app). Secondly, for the deeper answer, I don’t
          actually recommend learning Mongo for new developers. Although Mongo
          has its use cases, SQL is far more common in the workplace. There are
          a few companies that use Mongo or other NoSQL databases, but almost
          everyone uses some flavor of SQL. So, if you want to learn to connect
          a Node app to a database, I would recommend you go that way.
        </p>
      </div>
